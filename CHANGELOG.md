...
- `search_legislation` tool for full-text search across all Mexican federal statutes (Spanish)
...
[Unreleased]: https://github.com/Ansvar-Systems/mexican-law-mcp/compare/v1.0.0...HEAD
